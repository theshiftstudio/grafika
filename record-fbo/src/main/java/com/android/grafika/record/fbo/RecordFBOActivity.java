...
package com.android.grafika.record.fbo;
...
public class RecordFBOActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static class RenderThread extends Thread {
        ...
        /**
         * Pass in the Surface  View's SurfaceHolder.  Note the Surface may not yet exist.
         */
       ...
       /**
        ...
        private void startEncoder() {
            ...
            MuxerVideoEncoderCore encoderCore;
//            try {
                ...
                encoderCore = new MuxerVideoEncoderCore(config, EncoderStateCallback.Companion.getEMPTY());
