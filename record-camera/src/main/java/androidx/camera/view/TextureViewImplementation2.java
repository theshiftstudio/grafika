 ...
 */
final class TextureViewImplementation2 extends PreviewViewImplementation {
    ...
    public void initializePreview() {
        ...
        mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
             ...
             * {@link TextureViewImplementation2#mSurfaceRequest} is null), but the camera
             * is still using it (meaning {@link TextureViewImplementation2#mSurfaceReleaseFuture} is
             * not null), a listener must be added to
             * {@link TextureViewImplementation2#mSurfaceReleaseFuture} to ensure the surface
