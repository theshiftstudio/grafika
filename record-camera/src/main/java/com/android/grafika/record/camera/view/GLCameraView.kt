...
import com.android.grafika.videoencoder.VideoEncoderConfig.Companion.DEFAULT_AUDIO_SAMPLING_RATE
    ...
    init {
        attrs?.let {
            ...
            encoderConfig
                    ...
                    .audioSamplingRate {
                        array.getInteger(R.styleable.GLCameraView_audioSamplingRate, DEFAULT_AUDIO_SAMPLING_RATE)
                    }
                    .audioSource {
