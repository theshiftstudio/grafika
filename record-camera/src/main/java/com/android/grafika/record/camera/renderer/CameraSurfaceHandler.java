...
public class CameraSurfaceHandler extends Handler {
    ...
    private WeakReference<CameraSurfaceCallback> mWeakSurfaceHandler;

    public CameraSurfaceHandler(CameraSurfaceCallback handler) {
    ...
    public void handleMessage(Message inputMessage) {
        ...
        CameraSurfaceCallback cameraSurfaceCallback = mWeakSurfaceHandler.get();
        ...
        switch (what) {
            case MSG_SET_SURFACE_TEXTURE:
                cameraSurfaceCallback.handleSurfaceTextureAvailable((SurfaceTexture) inputMessage.obj);
                break;
            case MSG_PAUSE_SURFACE:
                cameraSurfaceCallback.pauseSurface();
                break;
            default:
