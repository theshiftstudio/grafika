 ...
 */
public class VideoEncoderCore extends BaseEncoderCore {
    ...
    final private Surface mInputSurface;

    /**
     * Configures encoder and muxer state, and prepares the input Surface.
     */
    public VideoEncoderCore(Muxer muxer, VideoEncoderConfig config) throws IOException {
        mMuxer = muxer;
