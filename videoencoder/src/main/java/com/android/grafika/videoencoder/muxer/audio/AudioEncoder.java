...
public class AudioEncoder implements Runnable {
    ...
    public AudioEncoder(Muxer muxer, AudioEncoderConfig config) throws IOException {
        init(muxer, config);
    }

    private void init(Muxer muxer,AudioEncoderConfig config) throws IOException {
        mEncoderCore = new AudioEncoderCore(config.getNumChannels(),
                config.getBitrate(),
        ...
        startThread();
        if (VERBOSE) Log.i(TAG, "Finished init. encoder : " + mEncoderCore.getEncoder());
    }
    ...
    public void reset(Muxer muxer, AudioEncoderConfig config) throws IOException {
    ...
    public void run() {
        ...
        if (VERBOSE) Log.i(TAG, "Begin Audio transmission to encoder. encoder : " + mEncoderCore.getEncoder());
