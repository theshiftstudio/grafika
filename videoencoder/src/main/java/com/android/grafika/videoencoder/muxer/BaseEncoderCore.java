 ...
 * @hide
 */
public abstract class BaseEncoderCore {
    ...
    public void adjustBitrate(int targetBitrate){
        if(Utils.INSTANCE.isKitKat() && mEncoder != null){
        ...
        }else if (!Utils.INSTANCE.isKitKat()) {
...
//                }
    ...
    private boolean isSurfaceInputEncoder() {
        return this instanceof VideoEncoderCore;
    }
